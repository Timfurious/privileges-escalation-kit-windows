...
Finally, restart the service either by rebooting the computer or manually through the Services application. You will then receive a shell with NT AUTHORITY\SYSTEM privileges.
